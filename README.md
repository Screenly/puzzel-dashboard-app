...
| `api_base_url`      | Base URL of the Puzzel Contact Centre REST API. Override to point at a local mock server during development. | No       | `https://api.puzzel.com/ContactCentre5` |
